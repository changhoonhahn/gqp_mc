...
\ch{a statement on how well flux calibration works citing a KP1 paper}.
...
\todo{More science applications will be listed here based on any feedback}.
...
The ultimate goal of any observational galaxy study is to infer the full
distribution of galaxy properties given a set of galaxy observations: 
$p(\theta | \{X_i\})$.
