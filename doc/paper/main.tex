...
\begin{abstract}
    ...
    spectra and photometry, constructed using galaxies in the {\sc L-Galaxies}
    semi-analytic model.
    We then compare the inferred galaxy properties to the true galaxy
    ...
    significant impact on the posteriors. 
