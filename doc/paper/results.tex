...
find clearn biases in the constraints. 
...
neither $r_{\rm fiber}$ nor $r$ magnitudes significantly affect
$\mu_{\Delta_{\log M_*}}$ and $\sigma_{\Delta_{\log M_*}}$.
...
bias in the inferrd for quiescent galaxies where we overestimate $\avgsfr$. 
