...
\caption{
    ...
    \edits{
        For each simulated galaxy, we plot 10 samples of the marginalized
        posterior of $\theta$.
        We also include violin plots of the marginalized posteriors for a
        handful of randomly selected galaxies.
    }
