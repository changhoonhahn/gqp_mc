...
approximately log-spaced lookback time bins. %15 lookback time bins approximately log-spaced between $t=0$ and $13.8$ Gyrs. 
...
%\todo{@rita how come?}
% this is consistent with the L-Galaxies paper taht constructed colors
