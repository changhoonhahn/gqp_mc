...
galaxies.
\lgal~model parameters are calibrated against observations at four different
redshifts from $z = 3$ to 0.
They match the observed stellar mass function and passive (quiescent) fraction,
which they estimate for the model by forward modeling U, V, and J photometry. 
