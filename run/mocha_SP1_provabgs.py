...
ivar_flux_obs   = np.load(os.path.join(dat_dir, 'mocha_s1.ivar.npy')) 
...
def run_mcmc(i_obs): 
    fchain_npy  = os.path.join(dat_dir, 'provabgs_mocks', 'SP1.provabgs.%i.chain.npy' % i_obs)
    fchain_p    = os.path.join(dat_dir, 'provabgs_mocks', 'SP1.provabgs.%i.chain.p' % i_obs)
